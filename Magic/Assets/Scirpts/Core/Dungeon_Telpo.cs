...
public class Dungen_Telpo : MonoBehaviour
{
    ...
    void Awake() {
        ...
        if (goLevel5Button)   goLevel5Button.onClick.AddListener(() => LoadScene(D_LV5));
        if (goLevel10Button)  goLevel10Button.onClick.AddListener(() => LoadScene(D_LV10));
    }
